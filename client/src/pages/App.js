...
export class App extends Component {
    ...
    // After the render, he will ask for permission, if accepted, it will send to action
    // the device location(lat, lon) and get the weather of it.
    componentDidMount() {
    ...
    // Search submit, send to action
    handleSubmit = e => {
        e.preventDefault();
        this.props.fetchCityWeather(this.state.city);
    };

    // Function helper to change state which helps to demonstrate the fahr or celsius
    // Temperatures
    handleConvertTemp = () => this.setState({ convertedTemp: !this.state.convertedTemp });
