...
declare global {
    ...
    interface IHeaderProps extends React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>> {        
        children: React.ReactNode;
    }
    ...
    interface IDetailsTemperatureProps extends React.HTMLAttributes<HTMLDivElement> {
        climate:string;
        humidity: string;        
        pressure: string;
        wind:string;
