...
describe("ForecastToday.vue", () => {
    it("should render correct contents", () => {
        ...
        expect(
            getMountedComponent(ForecastToday, {
                temp: "Testing temp prop!"
            }).temp
        ).to.equal("Testing temp prop!");
        ...
        ).to.equal("Testing humidity prop!");
        ...
        ).to.equal("Testing pressure prop!");
        ...
        ).to.equal("Testing condition prop!");
    });
});
