...
export default class ConverteUnidadeGrandeza {
    ...
    static converteCelsiusParaFahrenheit(valorCelsius) {
        return (parseInt(valorCelsius) / 5) * 9 + 32;
    }

    static converteFahrenheitParaCelsius(valorFahrenheit) {
        return ((parseInt(valorFahrenheit) - 32) / 9) * 5;
    }

    static converteMiliBarParaPascal(miliBar) {
    ...
    static converteMilhaParaKilometros(milha) {
        return (parseFloat(milha) * 1.60934).toFixed(0);
    }
}
