...
export default class TempoDepoisAmanhaController {
    constructor() {
        ...
        this.viewContainerPrevisao = document.querySelector(
            ".previsao_depois-amanha"
        );
        this.viewIconeTempo = document.querySelector(
            ".previsao_depois-amanha .icone-tempo_pequeno"
        );
        this.viewTemperatura = document.querySelector(
            ".previsao_depois-amanha .temperatura"
        );
    }
