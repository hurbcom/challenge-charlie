  ...
  return (
    ...
    >
      ...
      <div className="relative w-1/2 h-full flex flex-col">
        ...
        />
        {/*"Hoje" tag*/}
        <p className="absolute md:bottom-4 bottom-8 left-4 font-montserrat font-light text-[6vw] md:text-2xl text-dark">
          Hoje
        </p>
      </div>
      ...
      <div className="relative w-[50%] h-full md:py-[3%] flex flex-col items-center overflow-hidden justify-center">
        ...
        <div>
          ...
          <h1 className="text-center font-montserrat font-normal text-[6vw] md:text-2xl text-dark md:leading-7">
            {location.city}
          </h1>
        </div>
        ...
        <div className="w-[90%] md:h-[30%] flex flex-row justify-between items-start">
          ...
          <div className="mx-[1.5%] flex flex-col">
            ...
            <p className="text-center text-[3vw] md:text-sm font-montserrat text-dark font-semibold leading-tight">{`${forecast.windSpeed} km/h`}</p>
            <p className="text-center text-[2vw] md:text-xs font-montserrat text-dark font-semibold leading-tight">
          ...
          <div className="mx-[1.5%] flex flex-col">
            ...
            <p className="text-center text-[3vw] md:text-sm font-montserrat text-dark font-semibold leading-tight">{`${forecast.pressure}hPa`}</p>
          </div>
        </div>
      </div>
    </section>
